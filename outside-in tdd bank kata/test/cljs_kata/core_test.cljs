(ns ^:figwheel-always cljs-kata.core-test
  (:require
   [cljs.test :as test :include-macros true :refer [report]]
    [cljs-kata.acceptance-tests]
    [cljs-kata.account-tests]
    [cljs-kata.transaction-repository-tests]
    [cljs-kata.statement-printer-tests]
